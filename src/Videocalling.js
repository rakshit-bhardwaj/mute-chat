...
function Menu({ joinCode, setJoinCode, setPage }) {
    return (
        <div className="home">
            ...
            <h1 className="Heading">MuteChat</h1>
            <button className="menubutton" onClick={() => setPage("create")}>Create Call</button>
            <input
                className="codeinput"
                value={joinCode}
            ...
            />
            <button className="menubutton" onClick={() => setPage("join")}>Answer</button>
