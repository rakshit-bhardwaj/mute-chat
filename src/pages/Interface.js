...
//     <button id="webcamButton" onClick={handleWebcam}>Start webcam</button>
//     <h2>2. Create a new Call</h2>
//     <button id="callButton" onClick={handleCall} disabled>Create Call (offer)</button>

//     <h2>3. Join a Call</h2>
//     <p>Answer the call from a different browser window or device</p>
    
//     <input id="callInput" />
//     <button id="answerButton" onClick={handleAnswer} disabled>Answer</button>
